...
Rebuild basic table for 1860 census
...
/*
Get basic elements of the Saxer persons
*/
SELECT count(*) FROM tv_biogr_base_1860 where "24626664" ~ 'geb.' LIMIT 10;

/*
Get women with own and husband's name
*/
SELECT count(*) FROM tv_biogr_base_1860 where "24626664" ~ 'geb.' LIMIT 10;
...
*/
SELECT "24626674", count(*) as freq FROM tv_biogr_base_1860 where "24626674" is not null group by "24626674" order by freq desc;


SELECT *
FROM tables.cell_24626627
WHERE fk_column = 24626674 LIMIT 10;



SELECT *
FROM data.class_column_mapping LIMIT 10;




SELECT t2.*
FROM information.entity_association t1, data.entity t2 
WHERE t1.fk_data_domain = t2.pk_entity  LIMIT 10;




SELECT t2.table_name, count(*), min(t2.tmsp_creation), max(t2.tmsp_creation)
FROM information.entity_association t1, data.entity t2 
WHERE t1.fk_data_domain = t2.pk_entity  --LIMIT 10;
